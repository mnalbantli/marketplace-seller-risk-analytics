...
**GMV-at-risk: rate and dollar concentration point in different directions.** Low-volume sellers churn at a much higher *rate* (85.7% of their own GMV is at risk, vs. 47.5% for high-volume sellers), confirming the order-volume pattern above. But high-volume sellers hold 93% of total marketplace GMV ($12.2M of $13.2M), so even their lower risk rate translates into 87.4% of total at-risk *dollars*, versus only 12.6% for the low-volume group. Both are true simultaneously, and they answer different business questions: *who is most likely to churn* (low-volume sellers) vs. *where retention budget should actually go* (high-volume sellers, since that's where the dollar exposure sits).
